...
const DESCS_EN = {
  fool: {
    confidence: "A gentle YES",
    descs: [
      "You don't need to have it all figured out. Love sometimes begins not with courage, but with an open heart.",
      "Being a little clumsy is fine. There's a real chance a new connection is about to open up.",
      "Even if you're not fully prepared, take the first step. An unexpected opportunity may be waiting.",
      "It's okay to feel nervous — it's your first time. Trying, even imperfectly, will serve you better than holding back.",
      "A small move beats a grand calculation right now. Just know the difference between bold and reckless.",
      "A good time to start a new routine or a small habit shift. Don't set the bar too high from the start.",
      "Go for it. Just don't try to control every outcome — let things unfold.",
    ],
  },
  magician: {
    confidence: "A strong YES",
    descs: [
      "You already have what it takes to make an impression. Express yourself with confidence and things will shift.",
      "The power to change things is in your hands. Words and actions can reshape the relationship.",
      "Now is a good time to show what you're capable of. Use what you have.",
      "Your focus and drive are on. If you draw on what you know, it will land.",
      "Your instincts and information are aligned. A well-considered choice can lead somewhere good.",
      "If you're willing, you can reset your habits. What you start managing today will show results.",
      "You can do this. Right now, action beats hesitation.",
    ],
  },
  highPriestess: {
    confidence: "A quiet NO",
    descs: [
      "Surface reactions aren't the whole picture. There's still a lot beneath the surface.",
      "Read the room rather than fill it with words. Jumping in too soon could backfire.",
      "What's visible isn't enough to decide on. Observe a little longer and read the context.",
      "Instead of rushing to an answer, go deeper into the concept. Quiet focus is what's needed.",
      "There are variables still not in play. Avoid hasty investments or decisions for now.",
      "Things might look fine on the outside, but your body's balance could be off. Rest and check in first.",
      "Waiting serves you better than acting right now. Something hasn't fully revealed itself yet.",
    ],
  },
  empress: {
    confidence: "An abundant YES",
    descs: [
      "This connection has real potential to grow. The more warmth you show, the richer it becomes.",
      "You have the capacity to nurture and develop this relationship. Care creates good momentum.",
      "The foundation for results is already in place. Keep pushing steadily and something solid will come.",
      "You grow without forcing it. Eat well, rest well, keep going — that's the answer.",
      "Returns or real gains are worth anticipating. Focus on healthy growth rather than aggressive expansion.",
      "Recovery and stability are trending in your favour. The more you look after yourself, the more energy returns.",
      "Good flow. Nurture it, and results will follow.",
    ],
  },
  emperor: {
    confidence: "A solid YES",
    descs: [
      "Attitude and reliability matter more than feelings right now. This could move toward something stable.",
      "The clearer you draw your lines, the healthier the relationship becomes. Someone needs to hold the centre.",
      "Taking the lead and building structure will get results. Leadership lands well right now.",
      "A plan and clear standards will bring the grades. Systems beat gut instinct here.",
      "Principled choices are the ones that pay off. Managing well beats risky bets.",
      "Your daily rhythm needs sorting. Consistency is the core of recovery.",
      "Good. Hold your ground and push through — things will line up the way you want.",
    ],
  },
  hierophant: {
    confidence: "A steady YES",
    descs: [
      "This could develop into something serious rather than casual. Traditional approaches actually work here.",
      "Reliable guidance and shared standards help. Getting on the same page builds the relationship.",
      "Sticking with what's proven gives you the edge. People who play by the rules get recognised.",
      "The orthodox approach is your strongest move. Textbooks, past papers, and routine will deliver.",
      "Familiar, safer choices serve you better right now. Adventurous moves outside the norm aren't advised.",
      "Your body responds better to established care than to shortcuts. Going back to basics brings stability.",
      "The conventional path is right for now. Follow tried and tested methods.",
    ],
  },
  lovers: {
    confidence: "An exciting YES",
    descs: [
      "There's a real chance your feelings are mutual. But it needs to come from genuine choice, not performance.",
      "A good relationship starts with choice. Rather than forcing a fit, check whether your truths actually align.",
      "If you're at a crossroads, go with what matches your heart and your values. It'll be the right call.",
      "Rather than doing more, find what genuinely works for you and commit to that direction.",
      "Don't just look at the conditions — choose what fits your own standards. You'll be more satisfied long-term.",
      "Choose the habits and practices your body actually responds to. Sustainability matters more than perfection.",
      "Yes, but it can't be just anything. Be clear about what you actually want.",
    ],
  },
  chariot: {
    confidence: "A breakthrough YES",
    descs: [
      "Commit to a direction and the relationship can move fast. Less hesitating, more deciding.",
      "Don't get swept along by feelings — stay centred. The one who holds the wheel controls the flow.",
      "You have the drive to push through. This is a time when momentum creates results.",
      "As long as your focus holds, you can break through. Don't let go of the wheel before you're done.",
      "Bold action can bring real opportunity. Just make sure your target is clear.",
      "Your energy is there. Manage the load and you can recover and improve at a solid pace.",
      "Go. Stay steady and the path opens.",
    ],
  },
  strength: {
    confidence: "A calm YES",
    descs: [
      "Softness gets further than force here. The gentler your approach, the more things ease.",
      "Don't suppress emotions — manage them. Composure is what keeps the relationship intact.",
      "The ability is already there. Tame the impatience and you'll get where you want to go.",
      "Anxiety and all, you can still do this. The capacity to hold on is working in your favour.",
      "Restraint matters more than ambition right now. Measured management beats emotional decisions.",
      "Steady recovery matters more than dramatic change. Slow, but clearly moving in the right direction.",
      "It'll work. Just don't force it — handle it with care.",
    ],
  },
  wheeloffortune: {
    confidence: "The tide is turning — YES",
    descs: [
      "An unexpected turning point could arrive. The current is shifting your way.",
      "The energy in this relationship could change. Even a stuck situation might open up.",
      "Opportunity can drop in suddenly. Luck tends to find people who are ready.",
      "Surprises could go either way — setback or windfall. Ride the wave either way.",
      "Volatility in the situation may increase. Position yourself well and it becomes an opportunity.",
      "Your energy levels may fluctuate, but the overall direction isn't bad. Riding the rhythm is key.",
      "Good. This is a moment when change pays off more than staying still.",
    ],
  },
  justice: {
    confidence: "A rational YES",
    descs: [
      "It's not just about feelings — balance and responsibility matter here too. Honesty leads to the best answer.",
      "Fairness matters more than who's right or wrong. A balanced stance is what rights the relationship.",
      "Clear criteria and rational judgment will bring results. What's overdue will get addressed.",
      "Analyse objectively. Reviewing what you know and filling the gaps is the fastest path to results.",
      "A fair and well-considered approach is the winning move. Honest management builds credibility.",
      "Assess your actual condition clearly. Unnecessary effort needs cutting; where you're falling short needs attention.",
      "Yes. Face the situation clearly and a fair resolution will come.",
    ],
  },
  hangedMan: {
    confidence: "Not yet — NO",
    descs: [
      "The usual approach won't work here. Try seeing the relationship from a completely different angle.",
      "Before acting, pause. Stepping back often reveals what you couldn't see from inside.",
      "Waiting for the right timing rather than forcing progress will lead to better results.",
      "Suspend what you think you know. Fresh perspective often unlocks what study has blocked.",
      "Instead of pushing forward, take a step back and reassess. New perspective often means better returns.",
      "Forcing things when your body is asking for rest tends to backfire. Pause, then resume.",
      "Hold off for now. A deliberate pause often opens up options you couldn't see before.",
    ],
  },
  death: {
    confidence: "Time to end it — NO",
    descs: [
      "Something needs to end for something new to begin. Holding on to what's already gone is draining you.",
      "A relationship that's run its course needs to be released. Letting go creates space for something real.",
      "The current approach has run its course. A complete reset will take you further.",
      "Old methods aren't delivering anymore. Dropping habits that don't serve you is the first move.",
      "Some losses are actually gains in the long run. Cutting what isn't working is a strategic move.",
      "Your old lifestyle isn't sustainable anymore. A fundamental change in how you manage your health is due.",
      "One chapter needs to close. Real change begins when you're willing to let something go.",
    ],
  },
  temperance: {
    confidence: "A measured YES",
    descs: [
      "Rushing won't help here. Patience and steady investment in the relationship will pay off.",
      "Balance between giving and taking is what makes this work. Extremes in either direction will create friction.",
      "A moderate, consistent approach brings the best results. Stability beats big swings.",
      "Don't try to cram everything at once. Steady, well-paced study produces results.",
      "Gradual, well-balanced choices are more reliable than chasing big wins. Keep risk in proportion.",
      "Find your sustainable pace rather than forcing intensity. Long-term consistency is the key.",
      "Yes. Keep the balance and things will settle into place.",
    ],
  },
  devil: {
    confidence: "A tempting NO",
    descs: [
      "Desire or attachment may be clouding your judgment. Going with this as-is carries real risk of regret.",
      "If something feels controlling or suffocating, it needs to be looked at honestly. Dependency isn't love.",
      "Be clear about what's really driving this decision. Acting from anxiety or greed tends to lead somewhere you don't want.",
      "If distraction or avoidance is behind your approach, the results will reflect it. Face it head on.",
      "Greed or fear may be driving the choice. Awareness is the first move before anything else.",
      "If you know a habit is hurting you but keep going, the cost will compound. Now is the time to break it.",
      "Pause before acting. Ask yourself honestly what's really behind this.",
    ],
  },
  tower: {
    confidence: "A sharp NO",
    descs: [
      "Something built on a shaky foundation is close to collapse. A difficult but honest conversation is unavoidable.",
      "The tension that's been building will need to surface. A direct confrontation may actually clear things.",
      "Collapse may be exactly what's needed for something better to be built. Resistance only prolongs it.",
      "A system that looked solid may crack under pressure. Now is the time to audit what you're relying on.",
      "A sudden loss or exposure of something hidden may be coming. Taking cover is wiser than risking more.",
      "Ignoring the warning signs your body has been sending is becoming harder. A breaking point may be near.",
      "Be prepared. What's coming might be destabilising, but it clears the way for what actually needs to happen.",
    ],
  },
  star: {
    confidence: "YES",
    descs: [
      "After difficulty comes a quiet sense of hope. This is a time to believe gently in the possibility ahead.",
      "What felt hopeless may slowly begin to heal. Give it time and space.",
      "A long effort is beginning to see light. Keep your direction and trust the process.",
      "Even when exhausted, there's still something worth holding on to. Small progress is still progress.",
      "After a rough period, a calmer phase is approaching. Good things tend to come to those who keep going.",
      "Your body is beginning to find its rhythm again. Steady, gentle care is what sustains the recovery.",
      "There's reason to hope. Move gently, keep your eyes on where you're headed.",
    ],
  },
  moon: {
    confidence: "Not quite — NO",
    descs: [
      "Emotions are shifting and hard to read clearly. Don't make major decisions while things are this unclear.",
      "Illusion and truth are tangled right now. Hold off on commitments until the picture clears.",
      "The information available is incomplete. What looks certain may turn out to be quite different.",
      "Anxiety may be distorting your view. Study while your nerves are managed, not while they're running the show.",
      "Hidden risks or unknowns are still in play. This isn't the time to commit to something irreversible.",
      "Uncertainty and restlessness are part of the cycle. Don't force anything — let your body tell you what it needs.",
      "Not yet. The fog hasn't lifted. Wait until things come into focus.",
    ],
  },
  sun: {
    confidence: "A powerful YES",
    descs: [
      "The energy is warm and genuine. Good things are on their way.",
      "A bright, joyful connection is either here or coming. Enjoy it fully.",
      "Success and recognition are within reach. You're in a phase where effort pays off clearly.",
      "Your clarity and focus are strong. Results will show.",
      "A positive, high-energy phase for growth and gains. Good momentum — use it.",
      "Your health and vitality are on the rise. You're in good shape to maintain and build.",
      "Yes. Things are working. Keep going.",
    ],
  },
  judgement: {
    confidence: "An awakening YES",
    descs: [
      "A moment of honest reckoning is arriving. Past choices are surfacing — face them clearly.",
      "Unresolved things from the past may need addressing before you move forward.",
      "A major shift or turning point is coming. Whether you're ready or not, things are moving.",
      "A realisation about where you've been and where you need to go is taking shape. Trust it.",
      "A time of reassessment is here. What's been working and what hasn't is becoming clear.",
      "Your body is asking for a deeper kind of reset — not just physical, but a real change in approach.",
      "Time to face things honestly and make a clear call. What you decide now will matter.",
    ],
  },
  world: {
    confidence: "A complete YES",
    descs: [
      "A natural completion is within reach. Things are coming together in a meaningful way.",
      "The relationship has reached a stage of wholeness. Appreciate where you are.",
      "A project or goal is nearing its full expression. Finish it properly.",
      "Mastery is within reach. The effort has accumulated — now let it land.",
      "A cycle of success is reaching its peak. Consolidate what you've built.",
      "Your wellbeing is in a state of real balance. This is the result of sustained care.",
      "Yes, fully. This is the moment of completion. Receive it.",
    ],
  },
  hermit: {
    confidence: "Not yet — NO",
    descs: [
      "Time alone and inner reflection are what's needed right now, not another person.",
      "Rather than seeking connection outward, look inward. Understanding yourself better changes everything.",
      "This isn't the moment for external recognition. Do the quiet work first.",
      "Deep, solitary focus is more valuable right now than collaboration or distraction.",
      "Stepping back from the noise and reflecting on your direction will serve you better than action.",
      "Your body and mind need stillness. Restoration comes through rest, not push.",
      "Slow down. The answer comes from within, not from outside.",
    ],
  },
};
